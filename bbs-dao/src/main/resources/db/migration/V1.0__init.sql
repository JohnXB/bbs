/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2018/12/28 11:12:37                          */
/*==============================================================*/
...
(
   ...
   gender               varchar(5) character set utf8,
...
(
   id                   int(11) not null auto_increment,
   permission_name      varchar(50) character set utf8,
   permission_code      varchar(500) character set utf8,
...
(
   ...
   role_code            varchar(50) character set utf8,
   primary key (id)
)
ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
